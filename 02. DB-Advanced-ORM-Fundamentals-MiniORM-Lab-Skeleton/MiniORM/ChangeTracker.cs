...
namespace MiniORM
{
    // ChangeTracker – Responsible for tracking the added, modified and deleted entities from the DbSets.
    // Every DbSet has one. Used by the DbContext to persist changes into the database.
