...
namespace MiniORM
{
    // DbSet<T> – Custom generic collection, which holds the actual entities inside it. 
    // The DbContext class has several DbSets, which correspond to all the tables in the database.
